...
class Result
{
    ...
    public static int legoBlocks(int n, int m)
    {
        ...
        // Step 1: Compute total ways to fill one row of width i
        ...
        // Step 2: Total ways to build a wall of height n (no stability constraint)
        ...
        // Step 3: Remove unstable walls using inclusion-exclusion
